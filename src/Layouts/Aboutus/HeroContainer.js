  ...
  return (
    <div>
      <div className="container-xxl px-3 px-sm-4">
        <div
          className="d-flex align-items-center flex-column mx-auto p-2"
          style={{ width: "100%", maxWidth: "900px" }}
        >
            <h1 className="text-center main__txt display-5 my-4">About Us</h1>
            ...
            <div className="row w-100 mb-3 g-4">
              <div className="col-3">
